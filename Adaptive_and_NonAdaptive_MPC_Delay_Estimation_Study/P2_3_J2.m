%% Amirhossein Ehsani Simulation 4 _ Q2 _ MPC J2
clc
clear all
close all
...
for i = skip_instances:num_samples-d     
    ...
    control_u(i) = beta_0 * (desired_output(i+d) - filter_signal(alpha, output_y, i) - filter_signal(beta_prime, control_u, i-1)) / (beta_0^2 + landa);
end
