%% Amirhossein Ehsani Simulation 4 _ Q3 _ Adaptive Weighted One Step Ahead
clc
clear all
close all
...
B_estimated = [0, 10]; % First element must be zero
...
noise_variance = 0.0001; % System noise variance
