%% Amirhossein Ehsani_810602159_ Sim 3_ Q1_IndirSTR _With White Noise
clc;
clear all;
close all;
...
controlSignal = (-1).^-ceil(timeVector/100);
...
systemNoiseVariance = 0.000; % System noise variance
...
for i = initialSamples:numberOfSamples
    ...
    output(i) = phi.' * theta_actual + noise_t;
